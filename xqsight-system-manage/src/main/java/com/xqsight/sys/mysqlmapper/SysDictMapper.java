...
public interface SysDictMapper {
	...
	@Insert("INSERT INTO SYS_DICT (DICT_NAME,DICT_CODE, ACTIVE, CREATE_TIME, CREATE_OPR_ID, UPDATE_TIME, UPD_OPR_ID, REMARK) VALUES("
			+ "#{dictName, jdbcType=VARCHAR},#{dictCode, jdbcType=VARCHAR},#{active, jdbcType=NUMERIC},#{createTime, jdbcType=TIMESTAMP} ,#{createOprId, jdbcType=VARCHAR} , #{updateTime, jdbcType=TIMESTAMP} , #{updOprId, jdbcType=VARCHAR} , #{remark, jdbcType=VARCHAR})")
	void saveSysDict(SysDict sysDict);

	@Insert("INSERT INTO SYS_DICT_DETAIL (DICT_ID,DICT_VALUE,DICT_DESP,DICT_LANG, ACTIVE,EDITABLE, CREATE_TIME, CREATE_OPR_ID, UPDATE_TIME, UPD_OPR_ID, REMARK) VALUES("
			+ "#{dictId, jdbcType=VARCHAR},#{dictValue, jdbcType=VARCHAR},#{dictDesp, jdbcType=VARCHAR},#{dictLang, jdbcType=VARCHAR},#{active, jdbcType=NUMERIC},#{editable, jdbcType=NUMERIC},#{createTime, jdbcType=TIMESTAMP} ,#{createOprId, jdbcType=VARCHAR} , #{updateTime, jdbcType=TIMESTAMP} , #{updOprId, jdbcType=VARCHAR} , #{remark, jdbcType=VARCHAR})")
	...
	@Select("SELECT * FROM SYS_DICT_DETAIL WHERE DICT_ID = #{dictId, jdbcType=NUMERIC} ORDER BY DICT_DESP DESC")
